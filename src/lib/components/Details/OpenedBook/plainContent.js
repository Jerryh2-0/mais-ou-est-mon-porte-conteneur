let plainContent = [
    ...
    [
        ...
        ["p", "Me voici pour la première fois à bord d'un porte-conteneur, le Jean Mermoz. Mon rêve de devenir marin devient enfin réalité. Quelle chance qu'un matelot soit tombé malade et que CMA CGM accepte ma candidature."]
    ],
    [
